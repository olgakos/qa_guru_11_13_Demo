...
Дополнительные параметры, задействованные для выгрузки красткого отчета в Telegram Bot:
- `PROJECT_NAME`  название проекта
- `ENVIRONMENT` - тестовый стенд (prod, preprod, stage...), на котором запускались тесты. <i>В этом примере эти данные не заданы. Можно выставить любое значение из доступных в выпадающем списке</i>. 
